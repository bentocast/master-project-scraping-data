...
def screen_shot_processing(db, start):
    results = db.get_course_snapshot()
    for i in range(0, len(results)):
        ...
        image_path = "course_snapshot/{}.{}".format(course_id, r[2][-3:])
        ...
        db.insert_fact_course_thumbnail_aws_result(values)
        ...
        db.insert_fact_course_thumbnail_gcloud_result(values)
